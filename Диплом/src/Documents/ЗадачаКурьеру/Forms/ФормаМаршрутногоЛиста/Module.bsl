	...
	Процедура ПолучитьЭлементы(ВыделенныеСтрочки,парам) 
		...
		Для Каждого Строка Из ВыделенныеСтрочки Цикл
			...
			НоваяСтрока.Время = Задача.ДатаИВремяДоставки;
			НоваяСтрока.Адрес =  Задача.АдресДоставки;
			НоваяСтрока.Клиент = Задача.ФИО_клиента;
			НоваяСтрока.Сдача =  Задача.СдачаДляКурьеров;
			НоваяСтрока.СпособОплаты =  Задача.СпособОплаты;
			НоваяСтрока.Сумма = Задача.ИтоговаяСумма;
