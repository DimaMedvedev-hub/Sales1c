...
Процедура ДобавитьИзСпискаЗадачНаСервере()
	...
	|	ЗадачаКурьеру.ФИО_клиента КАК ФИО_клиента,
	|	ЗадачаКурьеру.ИтоговаяСумма КАК ИтоговаяСумма,
	|	ЗадачаКурьеру.Телефон КАК Телефон,
	|	ЗадачаКурьеру.АдресДоставки КАК Адрес,
	|	ЗадачаКурьеру.ДатаИВремяДоставки КАК ДатаИВремяДоставки,
	|	ЗадачаКурьеру.СдачаДляКурьеров КАК Сдача,
